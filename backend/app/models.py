...
class Paper(Base):
    ...
    document = relationship(
        "PaperDocument", back_populates="paper", uselist=False,
...
class PaperDocument(Base):
    ...
    extractor_version = Column(String, nullable=False, default="pypdf-v1")
...
class PaperChunk(Base):
    ...
    id          = Column(Integer, primary_key=True, autoincrement=True)
    paper_id    = Column(
        String, ForeignKey("paper_documents.paper_id", ondelete="CASCADE"), nullable=False
    )
